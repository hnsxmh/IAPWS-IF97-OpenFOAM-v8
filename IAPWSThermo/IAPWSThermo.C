...
void Foam::IAPWSThermo::heBoundaryCorrection(volScalarField& h)
{
...
Foam::tmp<Foam::scalarField> Foam::IAPWSThermo::he
(
    const scalarField& T,
...
const Foam::volScalarField& Foam::IAPWSThermo::psi() const
{
    return psi_;
}
